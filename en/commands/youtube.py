...
class YouTube:
    ...
    def later_watch(self):
        ...
        time.sleep(6)
        pyautogui.click(1185, 885, duration=0.25)
    ...
    def exit(self):
        pyautogui.press("esc")
        time.sleep(3)
        pyautogui.click (1660, 54, duration=0.25)
        
        
#pyautogui.moveTo(1010, 45)
        
#pyautogui.moveTo(60,10, duration=0.15)
#time.sleep(1)
#pyautogui.moveTo(1660, 54, duration=0.25)
